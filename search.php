                    ...
                    <div class = "product">
                        <div class = "product-content">
                            ...
                            <button type = "button" class = "btn-add" value = "add to list"
                              data-toggle="modal" data-target="#listModal" data-id="<?php echo $res['item_id'];?>"> Add to List 
                              </button> 
                                <a href="#">
  ...
  <body class="container">
    ...
    <header class="container blog-header py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 pt-1">
        <a href = "login1.php">
        <button type = "button" name="login-btn"  class="btn rounded-pill" style="background-image: linear-gradient(125deg,#971006, #a72879); color: white;">Login</button>
          </a>
        </div>
        <div class="col-4 text-center">
          <a class="blog-header-logo text-dark" href="home.php"
                    ...
                    <div class = "product">
                        <div class = "product-content">
                            ...
                            <button type = "button" class = "btn-add"
                                    data-toggle="modal" data-target="#loginAlertModal" data-id="<?php echo $res['item_id']?>"> 
                                    add to list
                                    </button>
                                <a href="#">
                                    <button  type = "button" id="<?= $res['item_id']; ?>" class = "btn-view"> view item
